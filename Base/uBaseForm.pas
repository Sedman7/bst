...
type
  ...
  public
    { Public declarations }
    FormStatus: String; //состо€ние формы view create edit
    RecivedID : Integer; //переданный ID - если 0 то нова€ запись, если > 0 то редактируема€
    Procedure Init;
...
begin
  if FormStatus<>'view' then Begin
    MessageBox(0, 'ќстались несохраненне данные.', '«акончите редактирование.', MB_ICONWARNING or MB_OK);
    action :=caNone;
    exit;
  End
  else Action:=caFree;
